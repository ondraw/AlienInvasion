...
public class GameHelperUtils
{
    ...
    public static int SIGN_IN_FAILED = 0;
    public static int MISCONFIGURED = 0;
    public static int LICENSE_FAILED = 0;
    public static void SetErrorMessageResouceID(int unknown_error,int sign_in_failed,int misconfigured,int license_failed)
    {
    ...
    private final static int[] RES_IDS = {
    	UNKNOWN_ERROR, //R.string.gamehelper_unknown_error, 
    	SIGN_IN_FAILED,//R.string.gamehelper_sign_in_failed,
    	MISCONFIGURED,//R.string.gamehelper_app_misconfigured, 
    	LICENSE_FAILED//R.string.gamehelper_license_failed
    };
